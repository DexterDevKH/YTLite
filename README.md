...
<details>
  ...
  <p>YTABConfig is a tweak developed by <a href="https://github.com/PoomSmart">PoomSmart</a> that allows you to access and modify YouTube's A/B flags directly.</p>
...
<details>
  ...
  <p>YouChooseQuality is a tweak developed by <a href="https://github.com/PoomSmart">PoomSmart</a> that forces the YouTube app to display the exact resolution options instead of the simplified ones (e.g., "Auto", "Higher picture quality").</p>
  <p>Source code and additional information are available <a href="https://github.com/PoomSmart/YouChooseQuality">in PoomSmart's GitHub repository</a>.</p>
</details>

<details>
  <summary>VolumeBoostYT</summary>
  <p>VolumeBoostYT is a tweak developed by <a href="https://github.com/VasirakCalgux">VasirakCalgux</a> that adds a volume boosting capability directly to the iOS YouTube app.</p>
  <p>Source code and additional information are available <a href="https://github.com/VasirakCalgux/VolumeBoostYT">in VasirakCalgux's GitHub repository</a>.</p>
</details>

<details>
  <summary>YTAnotherMiniplayer</summary>
  <p>YTAnotherMiniplayer is a tweak developed by <a href="https://github.com/PoomSmart">PoomSmart</a> that restores classic miniplayer styles or provides alternative customization for the YouTube miniplayer.</p>
